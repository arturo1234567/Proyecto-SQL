package edu.mx.tesoem.itics.arturomart.datossql;
...
public class editar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_codigo = (EditText)findViewById(R.id.editText5);

        et_descripcion = (EditText)findViewById(R.id.editText);
        et_precio = (EditText)findViewById(R.id.editText2);
        et_correo = (EditText)findViewById(R.id.editText3);
        et_edad = (EditText)findViewById(R.id.editText4);
